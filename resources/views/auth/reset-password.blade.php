                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Votre nouveau mot de passe doit être différent du précédent.</p>
                                </div>
                                    ...
                                    <form action="{{ route('password.update') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                                   ...
                                                   placeholder="Entrez votre email" required readonly>
                                            @error('email')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input @error('password') is-invalid @enderror" 
                                                       name="password" placeholder="Entrez le mot de passe" id="password-input" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" 
                                                       name="password_confirmation" placeholder="Confirmez le mot de passe" id="confirm-password-input" required>
                                            </div>
                                        </div>
