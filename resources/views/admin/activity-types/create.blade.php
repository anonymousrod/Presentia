...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Nouveau Type d'Activité</h4>
    ...
    <div class="col-xxl-6 col-lg-8">
        <div class="card">
            <div class="card-header align-items-center d-flex border-bottom-dashed">
                <h4 class="card-title mb-0 flex-grow-1">Créer un nouveau type d'activité</h4>
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.activity-types.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Ex: École de Dimanche, Réunion de Jeunes..." required>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="color" class="form-control form-control-color border @error('color') is-invalid @enderror" id="color" name="color" value="{{ old('color', '#3b82f6') }}" title="Choisir une couleur" required style="width: 60px; height: 38px; padding: 2px;">
                    ...
                    <div class="d-flex justify-content-end gap-2 border-top pt-3 mt-4">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="ri-save-3-line align-bottom me-1"></i> Créer le type
                        </button>
                    </div>
                </form>
            </div>
