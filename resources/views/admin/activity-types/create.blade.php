    ...
    <div class="col-12">
        <div class="d-flex align-items-lg-center flex-lg-row flex-column justify-content-between">
            <div class="flex-grow-1">
                <h4 class="fs-16 mb-1">Nouveau Type d'Activité</h4>
                <p class="text-muted mb-0">Renseignez les informations du nouveau type d'activité.</p>
            </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row align-items-end g-4">
                            ...
                            <div class="col-lg-7">
                                ...
                                <input type="text" class="form-control premium-input @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Ex: École de Dimanche, Réunion de Jeunes..." required style="height: 50px;">
                                @error('name')
                            ...
                            <div class="col-lg-2">
                                ...
                                <input type="color" class="form-control form-control-color premium-input px-1 py-1 w-100 @error('color') is-invalid @enderror" id="color" name="color" value="{{ old('color', '#3b82f6') }}" title="Choisir une couleur" required style="height: 50px;">
                                @error('color')
                            ...
                            <div class="col-lg-3">
                                <button type="submit" class="btn btn-primary btn-save w-100 d-flex align-items-center justify-content-center" style="height: 50px;">
                                    <i class="mdi mdi-check-all me-1"></i> Créer le type
                                </button>
                            </div>
                        </div>
