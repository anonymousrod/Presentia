            ...
            <form action="{{ route('admin.groups.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="category" name="category" class="form-control @error('category') is-invalid @enderror"
                            value="{{ old('category') }}" placeholder="Ex : Louvetisme, Éclaireurs...">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="color" id="color" name="color" class="form-control form-control-color w-100 @error('color') is-invalid @enderror"
                            value="{{ old('color', '#3B7DD8') }}" title="Choisir la couleur du groupe">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text text-info">
                        ...
                        La désignation d'un chef lui attribuera automatiquement le rôle "Chef de groupe".
                    </div>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="mdi mdi-check"></i> Créer le groupe
                    </button>
