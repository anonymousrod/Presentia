...
<head>
    ...
    <title>Liste de présence — {{ $activity->title }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="title-block">
        ...
        <div class="doc-main-title">Liste de Présence</div>
    ...
    <div class="meta-section">
        <table class="meta-box">
            <tr>
                ...
                <td style="width:25%;">
                    <span class="label">Total présents</span>
                    {{ $attendances->count() }} participant(s)
                </td>
            </tr>
    ...
    <div class="table-section">
        <div class="section-heading">Émargements enregistrés</div>
        <table class="data-table">
            <thead>
                <tr>
                    <th style="width:5%;">N</th>
                    <th style="width:28%;">Nom et Prénoms</th>
                    <th style="width:17%;">Provenance</th>
            ...
            <tbody>
                ...
                @foreach($attendances as $att)
                    <tr>
                        ...
                        <td>{{ $att->user->first_name }} {{ $att->user->name }}</td>
                        <td>{{ $att->user->groups->first()?->name ?? '—' }}</td>
                        <td class="center">{{ $att->user->phone ?? '—' }}</td>
                        ...
                        <td class="center">
                            ...
                            @elseif($att->status->value === 'EXCUSED')
                                <span class="badge-excused">Excusé</span>
                            @else
                                <span class="badge-other">{{ $att->status->label() }}</span>
                            @endif
                        </td>
                        <td class="center">
                            @if($att->scan_source === 'qr_code')
                                <span class="scan-qr">QR Code</span>
                            @else
                                <span class="scan-manual">Manuel</span>
                            @endif
                        </td>
                    </tr>
                @endforeach
