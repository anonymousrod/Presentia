    ...
    <div class="col-12">
        <div class="d-flex align-items-lg-center flex-lg-row flex-column justify-content-between">
            <div class="flex-grow-1">
                <h4 class="fs-16 mb-1">Créer une activité</h4>
                <p class="text-muted mb-0">Renseignez les informations de la nouvelle activité ci-dessous.</p>
            </div>
                ...
                <div class="card border-0 shadow-sm mb-4" style="border-radius: 1rem;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control premium-input @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Ex: Culte de jeunesse, Sortie d'évangélisation..." required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control premium-input @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Décrivez les objectifs et le programme de l'activité...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control premium-input @error('start_time') is-invalid @enderror" id="start_time" name="start_time" value="{{ old('start_time') }}" required>
                                @error('start_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control premium-input @error('end_time') is-invalid @enderror" id="end_time" name="end_time" value="{{ old('end_time') }}" required>
                                @error('end_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control premium-input with-addon @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location') }}" placeholder="Ex: Temple principal, Salle polyvalente...">
                                </div>
                                @error('location')
                                    <div class="text-danger mt-1 fs-12">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control premium-input with-addon @error('capacity') is-invalid @enderror" id="capacity" name="capacity" value="{{ old('capacity') }}" min="1" placeholder="Illimité">
                                </div>
                                @error('capacity')
                                    <div class="text-danger mt-1 fs-12">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="form-check form-switch form-switch-lg form-switch-success mb-0" dir="ltr">
                                    <input type="checkbox" class="form-check-input" id="is_registration_required" name="is_registration_required" value="1" {{ old('is_registration_required', false) ? 'checked' : '' }}>
                                </div>
                            </div>
                        ...
                        <div class="d-grid mt-4 pt-2">
                            <button type="submit" class="btn btn-primary btn-save">
                                <i class="mdi mdi-check-all me-1"></i> Créer l'activité
                            </button>
                        </div>
                    </div>
                </div>
